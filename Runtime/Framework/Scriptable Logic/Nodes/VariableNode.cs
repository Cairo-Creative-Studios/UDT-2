...
{
    [NodeTint("#60C1DB")]
    public class VariableNode : Node, IScriptableVariableHook
    {
        public string Name;
        ...
        public virtual void UpdateFromGet()
        {}
    }
    ...
    public class VariableNode<T> : VariableNode
    {
        ...
        public override void UpdateFromGet()
        {
            Value = setterNode.Value;
        }

        [SerializeProperty("Value", true)]
        public T value;
        [Output] public VariableNode<T> setterNode;
        [Input] public VariableNode<T> getterNode;
    }
